            ...
            <div className="main bg-gray-900 min-h-screen flex flex-col">
                <div className="relative isolate overflow-hidden flex-grow">
                    ...
                    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-14 lg:px-8">
                        <div className="sm:mx-auto sm:w-full sm:max-w-md"> {/* Increased max-width */}
                            <img
                                alt="Your Company"
                                src={logo}
                        ...
                        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-md"> {/* Increased max-width */}
                            <form action="#" method="POST" className="space-y-6">
                                ...
                                <div>
                                    <label htmlFor="marketvalue" className="block text-sm font-medium leading-6 text-white">
                                ...
                                <div>
                                    <label htmlFor="ownership" className="block text-sm font-medium leading-6 text-white">
                                        Is it your property?
                                    </label>
                                    <div className="mt-2">
                                        <select
                                ...
                                <div>
                                    <label htmlFor="nftimage" className="block text-sm font-medium leading-6 text-white">
                                        NFT Image
                                    </label>
                                    <div className="mt-2">
                                        <input
                                    ...
                                    <div className="mt-2">
                                        <label className="inline-flex items-center">
                                            <input
                                                ...
                                                required
                                            />
                                            <span className="ml-2 text-white">I agree to receive other communication from Block Land</span>
                                        </label>
                                    </div>
                                </div>
