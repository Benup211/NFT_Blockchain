...
import { usePropertyStore, PropertyType, Property } from '@/state/property-state'
...
export function PropertyListing() {
  ...
  const handleFilterChange = (searchTerm: string, maxPrice: number | null, propertyType: PropertyType | null) => {
    filterProperties(searchTerm, maxPrice, propertyType)
    setIsMobileFilterOpen(false)
  }

  const maxPossiblePrice = Math.max(...properties.map(p => parseFloat(p.price)))
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="lg:grid lg:grid-cols-4 gap-6">
        <div className="lg:col-span-1 mb-6 lg:mb-0 hidden lg:block">
          <PropertyFilter onFilterChange={handleFilterChange} maxPossiblePrice={maxPossiblePrice} />
        </div>
